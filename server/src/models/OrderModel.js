...
//       ` SELECT d.maDonDatVe, d.thoiGianDatVe, d.thoiGianThanhToan, d.trangThai, d.phuongThucThanhToan,
...
//         s.maSuKien, s.tenSuKien, s.anhBia, s.soNhaDuong, s.diaDiemToChuc,
...
//       groupedOrders[row.maDonDatVe].chiTiet.push({
  ...
  try {
    const [orders] = await connection.query(
      `SELECT d.maDonDatVe, d.thoiGianDatVe, d.thoiGianThanhToan,
        ...
        s.tenSuKien, s.anhBia, s.soNhaDuong, s.diaDiemToChuc, 
        px.tenPhuongXa, qh.tenQuanHuyen, tt.tenTinhThanh
      FROM DONDATVE d
      JOIN CHITIETDATVE ct ON d.maDonDatVe = ct.maDonDatVe
      JOIN LOAIVE lv ON ct.maLoaiVe = lv.maLoaiVe
