...
const ChangePassword = () => {
  ...
  const handleVerifyPassword = async (e) => {
    ...
    try {
      const storedPasswordHash = user.matKhau;
    ...
    <div>
      <Flex flexDirection="column">
        ...
        <ContentWrapper justifyContent="center">
          <Box>
            {step === 1 && (
              <Flex className="right-col" padding="24px" w="600px" gap={4}>
                <Box borderRadius="50%" bg="#ebf3f6" p={4}>
                  <LuShieldAlert
                    style={{ color: "#009fda", fontSize: "32px" }}
                  />
                </Box>
            ...
            {step === 2 && (
              <Flex className="right-col" w="440px" padding="24px " gap={4}>
                <Box borderRadius="50%" bg="#ebf3f6" p={4}>
                  <LuShieldCheck
                    style={{ color: "#009fda", fontSize: "32px" }}
                  />
            ...
            {step === 3 && (
              <Flex className="right-col" w="600px" padding="24px " gap={4}>
                <Box borderRadius="50%" bg="#ebf3f6" p={4}>
                  <LuKey style={{ color: "#009fda", fontSize: "32px" }} />
                </Box>
                ...
                >
                  <Flex flexDirection="column" gap={6}>
                    <Flex flexDirection="column" position="relative" gap={2}>
